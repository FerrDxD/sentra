// Data Pengurus Inti
        const pengurusData = {
            ketua: {
                ...
                hobi: 'Membaca, Public Speaking',
                motto: 'Memimpin dengan aksi, bukan sekadar posisi.',
                visi: 'Mewujudkan OSIS yang solid, inovatif, dan berintegritas sebagai wadah pengembangan potensi siswa.',
                misi: [
                    'Meningkatkan koordinasi dan komunikasi antar pengurus',
                    'Mengadakan program kerja yang bermanfaat bagi seluruh siswa',
                    'Membangun citra positif OSIS di lingkungan sekolah',
            ...
            wakil1: {
                ...
                kelas: 'XI IPA 2',
                tempatLahir: 'Bandung',
                tanggalLahir: '22 Maret 2008',
                alamat: 'Jl. Diponegoro No. 78, Bandung',
                hobi: 'Olahraga, Debat',
                motto: 'Bekerja keras dan bekerja cerdas.',
                programKerja: [
                    {
            ...
            sekum: {
                ...
                tanggalLahir: '5 Juli 2008',
                alamat: 'Jl. Pemuda No. 56, Semarang',
                hobi: 'Menulis, Desain Grafis',
                motto: 'Dokumentasi adalah kunci sejarah organisasi.',
                programKerja: [
                    {
                        nama: 'Sistem Administrasi Digital',
            ...
            sek1: {
                ...
                motto: 'Kerapian adalah cerminan profesionalisme.',
                programKerja: [
                    {
            ...
            bendum: {
                ...
                alamat: 'Jl. Sumatra No. 67, Medan',
                hobi: 'Berhitung, Mengelola Keuangan',
                motto: 'Transparansi adalah kunci kepercayaan.',
                programKerja: [
                    {
            ...
            ben1: {
                ...
                kelas: 'XI IPS 1',
                tempatLahir: 'Bali',
                tanggalLahir: '3 Januari 2008',
                alamat: 'Jl. Sunset Road No. 89, Bali',
                hobi: 'Traveling, Photography',
                motto: 'Setiap rupiah berarti untuk kemajuan.',
                programKerja: [
                    {
